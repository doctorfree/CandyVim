return {
  ...
  },
  {
    ...
    keys = {
      { "<Comma>1",    "<cmd>BufferLineGoToBuffer 1<CR>" },
      { "<Comma>2",    "<cmd>BufferLineGoToBuffer 2<CR>" },
      { "<Comma>3",    "<cmd>BufferLineGoToBuffer 3<CR>" },
      { "<Comma>4",    "<cmd>BufferLineGoToBuffer 4<CR>" },
      { "<Comma>5",    "<cmd>BufferLineGoToBuffer 5<CR>" },
      { "<Comma>6",    "<cmd>BufferLineGoToBuffer 6<CR>" },
      { "<Comma>7",    "<cmd>BufferLineGoToBuffer 7<CR>" },
      { "<Comma>8",    "<cmd>BufferLineGoToBuffer 8<CR>" },
      { "<Comma>9",    "<cmd>BufferLineGoToBuffer 9<CR>" },
